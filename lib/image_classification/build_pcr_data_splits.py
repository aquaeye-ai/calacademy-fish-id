"""
Builds train/val/test splits from two datasets, one given from /datasets/image_classification/pcr/scraped_obj_det and
one from /datasets/image_classification/pcr/scraped_web.  These two datasets' classes don't have to intersect.
"""
...
if __name__ == "__main__":
    ...
    yaml_path = os.path.join(config_dir, 'build_pcr_data_splits.yml')
